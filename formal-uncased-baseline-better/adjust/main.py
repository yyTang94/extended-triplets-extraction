...
def main(clean_folder: str, pretrained_embedding_location: str,
    ...
    # yd: relation
    train_relations_ = adjust_relation(train_relations, max_length, is_train=False)
    valid_relations_ = adjust_relation(valid_relations, max_length, is_train=False)
    test_relations_ = adjust_relation(test_relations, max_length, is_train=False)
